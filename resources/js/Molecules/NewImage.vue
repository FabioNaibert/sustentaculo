<template>
    <div>
        <div class="mt-6 c-new__player">
            <p>As imagens estão ligadas ao capítulo. Através delas, você pode adicionar pistas, mapas entre outros itens para ajudar durante a narrativa do capítulo.</p>
